...
export default function AuthPage() {
  ...
  const handleAuthSuccess = (data: { accessToken: string; refreshToken: string; user: any }) => {
            ...
            {step === "phone" ? (
              <form onSubmit={(e) => { void requestOtp(e); }} className="space-y-4">
                <div>
                  ...
                  <div className="flex overflow-hidden rounded-sm border border-[#E8E8E8] focus-within:border-primary">
                ...
                {error && (
                  <p className="rounded-sm bg-red-50 border border-red-100 px-3 py-2 text-xs text-[#E02B2B]">
                    {error}
                  </p>
                )}
                ...
                <button
                  ...
                  className="w-full rounded-sm bg-primary py-3 text-sm font-bold text-white transition-opacity hover:opacity-90 disabled:opacity-50"
                >
                ...
                {isDev && (
                  <div className="pt-2 border-t border-dashed border-gray-100 mt-4">
                    <button
                      ...
                      className="w-full rounded-sm border border-primary text-primary py-2.5 text-xs font-bold hover:bg-primary/5 transition-colors"
                    >
                      🚀 Quick Dev Login
                    </button>
              ...
              <form onSubmit={(e) => { void verifyOtp(e); }} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-sm border border-[#E8E8E8] bg-white px-4 py-3 text-center text-2xl tracking-[0.5em] text-[#1A1A1A] outline-none focus:border-primary"
                  />
                </div>
